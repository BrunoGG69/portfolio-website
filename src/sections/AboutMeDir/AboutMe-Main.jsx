        ...
        >
            ...
            <div className="w-full md:w-3/5 flex flex-col md:ml-8 mt-4 md:mt-0">
                ...
                <div className="flex flex-col text-white pt-10 text-xl">
                    ...
                    <div className="mt-8 relative p-4 border-2 border-[#5ec6bb] bg-[#1a1a1a] rounded-full">
                        <div
                        ...
                        <p className="font-bold text-lg sm:text-xl lg:text-2xl text-[#5ec6bb] text-center mt-4">

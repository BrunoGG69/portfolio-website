        ...
        >
          ...
          <div className="w-full md:w-3/5 flex flex-col md:ml-8 mt-4 md:mt-0">
            ...
            <div className="flex flex-col text-white pt-10 text-xl">
              ...
              {/* Motto section */}
              <div className="mt-8 relative p-4 border-2 border-[#5ec6bb] bg-[#1a1a1a] rounded-full shadow-[0_0_15px_#5ec6bb]">
                <div
                ...
                <p className="flex items-center justify-center font-bold text-lg sm:text-xl lg:text-2xl text-white text-center mt-4">
                  &quot;If it ain&apos;t broke, I&apos;m going to mess with it
                  anyway!&quot;
                </p>
              </div>
            </div>

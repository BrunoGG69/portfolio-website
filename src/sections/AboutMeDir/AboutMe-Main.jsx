        ...
        <div className="flex flex-col text-white pt-10 text-xl">
          <p className="gap-y-5 text-sm sm:text-lg lg:text-xl">
            <span>
              ...
              <span>
                {" "}
                student who enjoys tinkering and experimenting with technology.
              </span>
            </span>
            <br />
            <p className="pt-5">
              <span>
                I have a passion for software and web development, with skills
                in Python, JavaScript, C++, HTML, CSS, and ReactJS.
              </span>
            </p>
            <br />
            <p>
              <span>
                I am also a{" "}
                <a href="#techStacks" className="font-bold underline">
                  Robotics Enthusiast
                </a>
                , aiming to integrate my software knowledge with hardware.
              </span>
            </p>
            <p className="pt-5">
              <span>

    ...
    return (
        <div id = "hero" className="bg-transparent text-white flex items-center justify-center min-h-screen overflow-x-hidden">
            <div className="flex flex-col lg:flex-row items-center text-center lg:text-left w-full">
                <div className="flex flex-col text-center font-jetbrains p-8 lg:p-32  w-full">
                    {/* Name Section */}
                    ...
                    <p className="text-6xl max-lg:text-4xl max-sm:text-2xl mt-2 rise-up" style = {{animationDelay : "0.2s"}}>
                        <span className="neon-orange typing-effect">&lt;Coder/&gt;</span>
                        <span className="neon-white typing-effect ml-2">&lt;Tinkerer/&gt;</span>
                    </p>

                    {/* Separator Line */}
                    <div className="border-t border-white mt-4 mx-auto w-1/2 lg:w-1/3 rise-up" style = {{animationDelay : "0.4s"}}></div>

                    {/* Social Links Section */}
                    <div className="flex flex-wrap justify-center space-x-4 mt-4 w-full text-lg max-sm:text-sm max-md:text-lg max-lg:text-xl rise-up" style = {{animationDelay : "0.6s"}}>
                        {/* GitHub Icon */}
                        <a href="https://github.com/BrunoGG69" className="flex items-center space-x-1">
                            ...
                            <span className="sm:text-sm">BrunoGG69</span>
                        </a>
                ...
                <div className="flex-shrink-0 rise-up items-center justify-center" style={{ animationDelay: '0.5s' }}>
                    <img src={profilePic} alt="" className="p-10 w-full max-sm:w-[400px]" />
                </div>
            </div>
        </div>
    );

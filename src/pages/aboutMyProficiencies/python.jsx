    ...
    const information = [
        {
            ...
            cons: [
                "Slower Speed",
                "High Memory Usage",
                "Not ideal for Mobile and Game Dev",
                "Vulnerable to injection attacks",
                "Lacks Multi Threading"
            ],
            codeEditors: ["PyCharm", "Python", "VSCode"]
        }
    ];

    // Icons for matching editors
    const icons = [
        { name: "PyCharm", url: "https://brunogg69.github.io/icons/logos/pycharm.svg" },
        { name: "Python", url: "https://brunogg69.github.io/icons/logos/python.svg" },
        ...
        <main className="px-6 bg-black min-h-screen pt-20 flex flex-col">
            ...
            >
                ...
                <div className="flex items-center space-x-4">
                    <img
                        src="https://brunogg69.github.io/icons/logos/python.svg"
                        alt="Python Logo"
                        width={50}
                        height={50}

...
const TailwindCSS = () => {
    ...
    // Information array for TailwindCSS
    const information = [
        {
            features: [
                ...
                "Highly Configurable with Tailwind Config"
            ],
            pros: [
                "Rapid Prototyping",
                "Clean and Minimal CSS Files",
                "Great for Component-Based Libraries",
                "Wide Adoption and Strong Community",
                "Easy to Integrate with Any Framework"
            ],
            cons: [
                "Initial Learning Curve",
                "Verbose Classes in Markup",
                "Requires Configuration for Complex Projects",
                "Limited Native Component Styling",
                "Frequent Breaking Changes in Updates"
            ],
            codeEditors: ["VSCode", "WebStorm"]
        }
    ];
...
// Icons for matching editors
    const icons = [
        ...
        { name: "WebStorm", url: "https://brunogg69.github.io/icons/logos/webstorm.svg" },
    ];
        ...
        <main className="px-6 bg-black min-h-screen pt-20 flex flex-col">
            ...
            >
                ...
                <div className="flex items-center space-x-4">
                    <img
                        src="https://brunogg69.github.io/icons/logos/tailwindcss.svg"

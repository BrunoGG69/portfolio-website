...
const Js = () => {
    ...
    // Information array for Javascript
    const information = [
        {
            features: [
            ...
            cons: [
                "Cannot be used for Standalone app development",
                "Unanticipated Errors",
                "Steeper Learning Curve",
                "No Garbage Collection",
                "No Static Typing"
            ],
            codeEditors: ["Webstorm", "VSCode"]
        }
    ];
        ...
        <main className="px-6 bg-black min-h-screen pt-20 flex flex-col">
            ...
            >
                ...
                <div className="flex items-center space-x-4">
                    <img
                        src="https://brunogg69.github.io/icons/logos/js.svg"
                        alt="JS Logo"
                        width={50}
                        height={50}

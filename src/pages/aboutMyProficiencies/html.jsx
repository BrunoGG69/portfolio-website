    ...
    const information = [
        {
            features: [
                ...
                "Extensible with Modern Frameworks"
            ],
            pros: [
                "Widely Supported Across Browsers",
                "Easy to Learn and Use",
                "Forms the Basis of Web Development",
                "Rich Community and Resources",
                "Works Seamlessly with CSS and JavaScript"
            ],
            cons: [
                "Limited Styling and Interactivity",
                "Requires CSS and JavaScript for Complete Functionality",
        ...
        <main className="px-6 bg-black min-h-screen pt-20 flex flex-col">
            ...
            >
                ...
                <div className="flex items-center space-x-4">
                    <img
                        src="https://brunogg69.github.io/icons/logos/html.svg"
                        alt="HTML Logo"
                        width={50}
                        height={50}

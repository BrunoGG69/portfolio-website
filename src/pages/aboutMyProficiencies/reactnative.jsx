...
const ReactNative = () => {
    ...
    // Information array for React Native
    const information = [
        {
            features: [
            ...
            pros: [
                "Highly Reusable Code Across Platforms",
                "Rich UI and Animation Capabilities",
            ...
            cons: [
                ...
                "Requires Native Development Knowledge for Customizations",
        ...
        <main className="px-6 bg-black min-h-screen pt-20 flex flex-col">
            ...
            >
                ...
                <div className="flex items-center space-x-4">
                    <img
                        src="https://brunogg69.github.io/icons/logos/reactNative.svg"

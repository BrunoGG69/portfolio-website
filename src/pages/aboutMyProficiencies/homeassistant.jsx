...
const HomeAssistant = () => {
    ...
    // Information array for Home Assistant
    const information = [
        {
            features: [
                "Open Source Home Automation Platform",
                "Integrations with Over 1000 Devices and Services",
                "Custom Automation with YAML or UI",
            ...
            cons: [
                ...
                "May Need Additional Hardware (e.g., Raspberry Pi)",
        ...
        <main className="px-6 bg-black min-h-screen pt-20 flex flex-col">
            ...
            >
                ...
                <div className="flex items-center space-x-4">
                    <img
                        src="https://brunogg69.github.io/icons/logos/homeassistant.svg"

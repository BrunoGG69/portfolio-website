...
const Arduino = () => {
    ...
    // Information array for Arduino
    const information = [
        {
            features: [
                "Open Source Hardware and Software",
                "Easy to use for Beginners",
                "Supports Wide Range of Sensors and Modules",
            ...
            pros: [
                ...
                "Compatible with Wide Range of 3rd Party Components",
            ],
            cons: [
                "Limited Processing Power",
                "Not Suitable for Complex Applications",
                "Need External Modules for Advanced Features",
                "Low Memory and Storage Capacity",
                "IDE Very Basic (Arduino IDE)"
            ],
            codeEditors: ["Arduino", "VSCode"]
        }
    ];
        ...
        <main className="px-6 bg-black min-h-screen pt-20 flex flex-col">
            ...
            >
                ...
                <div className="flex items-center space-x-4">
                    <img
                        src="https://brunogg69.github.io/icons/logos/arduino.svg"
                        alt="Arduino Logo"
                        width={50}
                        height={50}
